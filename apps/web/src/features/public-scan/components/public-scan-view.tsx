...
export function PublicScanView() {
  ...
  return data ? <PublicContentFrame data={data} /> : <main className="public-content-page"><article className="public-content-card"><span className="index-label">TP QR / LOADING</span><h1>正在打开活码…</h1></article></main>;
}
